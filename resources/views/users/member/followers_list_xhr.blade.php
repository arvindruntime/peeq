...
@foreach ($response['data']['data'] as $member)
                    ...
                    <div class="card shadow p-3 border-0"> 
                      <div class="d-sm-flex flex-wrap align-items-center gap-2 justify-content-between">
                        <div class="d-flex align-items-center gap-2 mb-2 mb-sm-0">
                          ...
                          <div class="d-block">
                            <h6 class="mb-0 text-dark" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight10" aria-controls="offcanvasRight10"> {{ $member->first_name .' '.$member->last_name }}</h6>
                        ...
                        <div class="d-flex gap-3 align-items-center lm__member-btn">
                          ...
                          {{-- <div class="dropdown mt-1"><a class="dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"><span>
                            ...
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" onclick="OpenMemberModal('member_block_modal','{{ $member->first_name}}','{{ $member->id}}')" type="button" data-bs-toggle="modal">Block {{ $member->first_name}}</a></li>
                              <li><a class="dropdown-item" onclick="OpenMemberModal('reportMemberModal','{{ $member->first_name}}','{{ $member->id}}')" type="button" >Report {{ $member->first_name}}</a></li>
                            </ul>
                          </div> --}}
