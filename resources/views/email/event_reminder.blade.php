          ...
          <tr>
            <td
              ...
              <p
                ...
                We're delighted that you'll be joining us for the upcoming event on PEEQ™, scheduled for after one hour on {{ $startDateFormat }}! Your attendance is confirmed, and we're eagerly anticipating your presence. To ensure you're fully prepared, kindly review the information below:
              </p>
              <p
                style="margin-bottom: 1em; font-size: 16px; color: #8a8a8a; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;">
