...
{{-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.3.0/codemirror.min.css" /> --}}
    <main class="main-content" id="main">
        <section class="lm__dash-con lm__course-list-admin">
            ...
            <div class="container">
                <form method="post" name="formInteractive" id="formInteractive" enctype="multipart/form-data">
                    <input type="hidden" name="course_id" value="{{$course_id}}">
                    <input type="hidden" name="course_module_id" value="{{$course_module_id}}">
                    <div class="create-list-admin-title">
                        <p class="fs-4 mb-0 text-black"></p>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 mb-4">
                            <div class="pdf-editor">
                                ...
                                <!-- Used froala Editor -->
                                <div class="mb-3">
                                    <textarea class="ckplot rounded-3" rows="13" id="pdf_content" name="pdf_content"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6  mb-4">
                            <div class="interactive-editor">
                                ...
                                <!-- Used froala Editor -->
                                <div class="mb-3">
                                    <textarea class="ckplot rounded-3" rows="13" id="interactive_content" name="interactive_content"></textarea>
                                </div>
                            </div>
                        </div>
                        {{-- <div class="col-12">
                                    ...
                                    <div class="lm__module-add-con">
                                        <div class="lm__module-card p-0">
                                            <label class="position-relative thumb">
                                                <input class="form-control" id="audio_file" type="file" name="audio_file" accept=".mp3, .wav, .m4a, .ogg, .flac, .aac, .wma">
                                                <span
                        ...
                        <div class="col-12 my-3 text-center">
                            ...
                            {{-- <a class="btn btn--primary py-2 px-5" id="SaveBtnInteractive">Save</a> --}}
                            <button class="btn btn--primary py-2 px-5" id="SaveBtnInteractive" type="button">Save</button>
    ...
    <script>
        $(document).ready(function() {  
            ...
            $('#SaveBtnInteractive').click(function(e) {
            e.preventDefault();
            // var formData  = $("#contact-support").serialize()         
            let _token = $("input[name=_token]").val();
            
            var formData = new FormData($("#formInteractive")[0]);
            // formData.set('page_no', '2')
            // formData.set('status', '1')
        
                $.ajax({
                    url: "{{route('interactive.workbook.store')}}"
                    , type: "POST"
