    ...
    <section class="lm__dash-con mb-5 lm__module-add">
        ...
        <div class="container">
            <div class="row lm__module-add-con">
                <div class="col-12">
                    <div class="mb-3">
                        <a href="{{ route('admin.courses.inner', ['id' => $id]) }}" class="btn btn--primary rounded-4 py-2">Go Back</a>
                    </div>
                    <div class="lm__module-title">
                        <h3 class="fw-bold">Add Module</h3>
                    </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="lm__module-form">
                                                                    ...
                                                                    <p class="mb-2 text-sm-14">Choose what image to
                                                                        ...
                                                                        make this Module easier to recognize.
                                                                    </p>
                                                                    <img class="course_module_thumbnail_image_preview d-none mb-2" width="100" height="100">
                                                                    <label for="thumbnail_image"
                                                                        class="position-relative thumb">
                                                                        <input class="form-control"
                                                                            name="thumbnail_image" id="thumbnail_image"
                                                                            type="file" accept=".png, .jpg, .jpeg">
                                                                        <input name="thumbnail_image_tmp"
                                                                            id="thumbnail_image_tmp" type="hidden"
                                                                            value="">
                                                                        <span
                                                ...
                                                <div class="lm__module-card card">
                                                    <div class="row">
                                                                    ...
                                                                    <div class="lm__module-form mb-0">
                                                                        ...
                                                                        <div class="editor-container">
                                                                            <textarea class="ckplot" name="video_lesson"
                                                                                id='video_lesson'
                                                                                placeholder="Upload video lesson here ..."></textarea>
                                                                        </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="lm__module-button text-end">
                                                                    <a
                                                                        class="btn btn--primary videoBtn   CourseModuleSaveBtn" id="video_lesson_disable">Next</a>
                                                                </div>
                                                            </div>
                                                    </div>
                                                </div>
                                                                    ...
                                                                    <div class="lm__module-form mb-0 ">
                                                                        <div class="lm__module-form mb-0">
                                                                            <textarea class="ckplot"
                                                                                ...
                                                                                name="audio_recording_description"></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="lm__module-form">
                                                                    ...
                                                                    <label for="audio_recording"
                                                                        class="position-relative thumb">
                                                                        <input class="form-control" name="audio_recording" id="audio_recording" type="file" accept=".mp3,audio/*">
                                            ...
                                            <div class="tab-pane" role="tabpanel" id="step5">
                                                <div class="lm__module-card card">
                                                    <div class="row">
                                                                ...
                                                                <div class="lm__module-form mb-0">
                                                                    <div class="editor-container">
                                                                        <textarea class="ckplot" name="quiz_description"
                                                                            id='quiz_description'
                                                                            placeholder="Upload quiz description here ..."></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        {{-- <form action=""> --}}
                                                            <div class="col-12">
                                                                <a class="lm__module-form d-block createQuiz"
                                                                    target="_blank">
                                                                    <label for="formFile4"
                                                                ...
                                                                <div class="lm__module-form mb-0 ">
                                                                    ...
                                                                    <div class="lm__module-form mb-0">
                                                                        <textarea class="ckplot"
                                                                            ...
                                                                            name="reflection_questions"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            {{--
                                                ...
                                                <div class="lm__module-card card">
                                                    <div class="lm__ref">
                                                        <div class="lm__ref-title">
                                                            ...
                                                            <p class="text-sm-14">Add links related to the module for
                                                                reference.</p>
                                                        </div>
                                                        {{-- <form action=""> --}}
                                                            <div class="col-12">
                                                                <div class="lm__module-form mb-3 ">
                                                                    <div class="lm__module-form mb-0">
                                                                        <textarea class="ckplot" id="reference_link_description" name="reference_link_description"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="lm__module-form w-100">
                                                                <div class="d-flex gap-3 align-items-center">
                                                                    <input class="form-control shadow py-2" type="text" placeholder="Related Title" id="reference_title" name="reference_title[]">
                                                                    <input class="form-control shadow py-2" type="text" placeholder="Related Links" id="reference_link" name="reference_link[]">
                                                            ...
                                                            <span class="append_releted_link"></span>
                                                            <!-- Button -->
                                                            <div class="col-12">
                                                                <div class="lm__module-button text-end">
                                                                    <a
                                                ...
                                                <div class="lm__module-card card">
                                                    <div class="lm__ref">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="lm__module-form mb-3 ">
                                                                <div class="lm__module-form mb-0">
                                                                    {{-- <textarea class="ckplot" id="closure_video_description" name="closure_video_description"></textarea> --}}
                                                                    <textarea class="ckplot" id="closure_video_description" name="closure_video"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        {{-- <div class="col-12">
                                                            <div class="lm__module-form">
                                                                ...
                                                                <p class="mb-2 text-sm-14">Choose what video to display
                                                                    ...
                                                                    <p>
                                                                        <div class="d-flex gap-2 align-items-end video_thumbnailContainer d-none">
                                                                            ...
                                                                            </video><a class="removethumbnailVideo bg-white-42 shadow"> <img class="in-svg" src="{{ asset('assets/images/delete-fill.svg') }}" alt=""> </a>
                                                                        </div>
                                                                    </p>
                                                                ...
                                                                <label for="closure_video"
                                                                    ...
                                                                    <input name="closure_video_tmp" id="closure_video_tmp" type="hidden" value="">
                                                                    <span
                                                                        class="position-absolute top-50 start-50 translate-middle text-dark text-sm-14 text-center title-font text-nowrap">Upload
                                                                        Closing Video</span>
                                                                    </label>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="lm__module-button text-end">
                                                                <a
                                                                    class="btn btn--primary CourseModuleSaveBtn closure_video">Save</a>
                                                            </div>
                                                        </div>
                                                        </form>
                                                    </div>
...
<script>
    $(document).ready(function() {
            ...
            $('.add').on('click', function() {
                ...
                link +='<input class="form-control shadow py-2" type="text" name="reference_title[]" placeholder="Related Title" value="">';
                link +='<input class="form-control shadow py-2" type="text" name="reference_link[]" placeholder="Related Links" value="">';
                link +='<div class="lm_form-add flex-shrink-0 ms-0"><span class="add" onclick="remove_added_related_link(' +
                    i +
...
// });
            ...
            var postEditor = new FroalaEditor('#introduction', {
                ...
                fontFamily: {
                    buttons: ['Lato,sans-serif', 'fontFamily', 'Arial', 'Verdana', 'Tahoma', 'Times New Roman']
                },
            ...
            var postEditor = new FroalaEditor('#video_lesson', {
                ...
                events: {                   
                    ...
                    $('#video_lesson_disable').css({'pointer-events':'auto'});
                    },
                    'video.beforeUpload':function($vedio){
                        $('#video_lesson_disable').css({'pointer-events':'none'});
                    }
                }
            });
