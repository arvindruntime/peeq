                    ...
                    <div class="col-12">
                        ...
                        <div class="lm__quiz lm__quiz-admin mb-4 ">
                            <form action="#" name="createQuizwForm" id="createQuizwForm" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="question_type" id="question_type" value="multi_select">
                                <input type="hidden" name="course_id" id="course_id" value="{{ request()->query('course_id') }}">
                                <input type="hidden" name="course_module_id" id="course_module_id" value="{{ request()->query('course_module_id') }}">
                                ...
                                <div class="lm__quizbox active">
                                    <div class="lm__quiz-question shadow">
                                        ...
                                        <div class="position-relative lm__quizinput">
                                            <input name="question" id="question" class="form-control icon shadow py-3"
                                                type="text">
                                        </div>
                                    </div>
                                    <div class="lm__quiz--animation">
                                        <div class="lm_quiz-queimage p-0">
                                            ...
                                            <img  class="question_image_preview d-none mb-2" width="100" height="100">
                                            <label class="lm_upld" for="question_image">
                                                <div class="input-group mb-0"><span class="input-group-text p-0 mb-0">Upload
                                                    </span>
                                                    <input class="form-control" name="question_image" id="question_image" type="file">
                                                </div>
                                            </label>
                                        </div>
                                        <div class="lm__quiz-tab">
                                            <ul class="nav nav-pills mb-4 nav-primary shadow d-inline-flex" id="pills-tab"
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link active" onclick="setQuizType('multi_select')" id="pills-all-tab" data-bs-toggle="pill"
                                                        data-bs-target="#pills-all" type="button" role="tab"
                                                        aria-controls="pills-all" aria-selected="true">Multi Select</button>
                                                </li>

                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link" onclick="setQuizType('single_select')" id="pills-upcoming-tab" data-bs-toggle="pill"
                                            ...
                                            <div class="tab-content" id="pills-tabContent">
                                                ...
                                                <div class="tab-pane fade show active shadow" id="pills-all" role="tabpanel"
                                                    ...
                                                    <div class="lm__optionbox mb-3">
                                                        <div class="lm__option-choice d-flex align-items-center flex-wrap">
                                                            ...
                                                            <div class="position-relative lm__quiz-input">
                                                                <input name="option_m[]" id="option_multiple"class="form-control icon shadow py-3" type="text" placeholder="Multiple Choice">
                                                            </div>
                                                ...
                                                <div class="tab-pane fade shadow" id="pills-upcoming" role="tabpanel"
                                                        ...
                                                        <div class="lm__option-choice d-flex align-items-center flex-wrap">
                                                            <div
                                                                ...
                                                                <div class="form-check d-flex gap-2 mt-1">
                                                                    <input class="form-check-input" name="admin_answer_s[]" type="radio" value="1">
                                                                </div>
                                                            </div>
                                                            {{-- <div class="lm_upld">
                                                            ...
                                                            <div class="position-relative lm__quiz-input">
                                                                <input name="option_s[]" class="form-control icon shadow py-3" type="text" placeholder="Single Choice">
                                                            </div>
                                ...
                                <div class="lm__quizbtn w-100 d-flex justify-content-end">
                                    <a class="btn btn--dark mt-3 me-2 me-lg-3 QuizSaveBtn" onclick="SaveQuiz('QuizSave',{{ request()->query('course_module_id') }})">Add New Question </a>
                                    <a class="btn btn--primary mt-3 getQuizPreview" onclick="SaveQuiz('SaveAndQuizPreview',{{ request()->query('course_module_id') }})">Save & Preview </a>
                                </div>
                            </form>
                        </div>
                    </div>
...
function handleSelectSingle(formData) {
    var adminAnswers = $("input[name='admin_answer_s[]']:checked").map(function () {
        return $(this).val();
    }).get();

    var options = $("input[name='option_s[]']").map(function () {
        return $(this).val();
    }).get();
    ...
    function printErrorMsg(msg) {
        ...
        $(document).ready(function() {
            ...
            $('.multi_add').on('click', function() {
              ...
              link +='<div class="lm__optionbox mb-3"><div class="lm__option-choice d-flex align-items-center flex-wrap"><div class="lm__term d-flex justify-content-center"><span>'+incrementAlphabet_multiple()+'.</span><label class="lm-check-term ps-4 mb-0 lh-1 text-white"><input name="admin_answer_m[]" value="'+i+'" type="checkbox"><span class="checkmark"></span></label></div>'
            ...
            $('.single_add').on('click', function () {
              ...
              link+='<div class="form-check d-flex gap-2 mt-1"><input class="form-check-input" name="admin_answer_s[]" value="'+i+'" type="radio"></div></div>';
            ...
            $('#question_image').change(function() {
                var file = this.files[0];
                    if (file) {
                        ...
                        $(".question_image_preview").removeClass('d-none');
                        $(".question_image_preview").addClass('d-block');
                        }
